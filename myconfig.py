...
parser.add_argument("--contrastive_method", type=str, default='simclr', help='simclr, gcl(global contrastive learning), pcl(positional contrastive learning), coral(CORAL)')

# Loss
parser.add_argument("--temp", type=float, default=0.1)
parser.add_argument("--slice_threshold", type=float, default=0.05)
parser.add_argument("--alpha", type=float, default=1.0, help='Weight for OAL (directional loss) in CORAL.')
parser.add_argument("--apply_soft_weights", default=True, action='store_true', help='Apply sigmoid-based soft weighting')
parser.add_argument("--no_soft_weights", dest='apply_soft_weights', action='store_false', help='Disable soft weighting')
parser.add_argument("--sigmoid_scale", type=float, default=1.0, help='Scale parameter (tau)')
